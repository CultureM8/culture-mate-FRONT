...
export function createAuthenticatedStompClient(endpoint, options = {}) {
  ...
  const client = new StompClient({
    ...
    // STOMP 연결 전 로그
    beforeConnect: () => {
      console.log('🔑 STOMP 연결 시도 - 토큰 길이:', token.length);
      console.log('🔗 연결 헤더:', client.connectHeaders);
    },
