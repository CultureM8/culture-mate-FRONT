...
/**
 * 통합 이벤트 조회 (검색 조건이 있으면 검색, 없으면 전체 조회)
...
export const getEvents = async (searchParams = {}) => {
  try {
    ...
    // 검색 조건이 있으면 /search 엔드포인트 사용, 없으면 기본 엔드포인트 사용
    const hasSearchConditions = Object.keys(searchParams).length > 0 && 
      Object.values(searchParams).some(value => value !== undefined && value !== null && value !== "");
