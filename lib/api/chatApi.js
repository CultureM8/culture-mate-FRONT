...
const chatApi = {
  ...
  getMessages: async (roomId, params = {}) => {
    try {
      ...
      const url = qs
        ? `${API_URL}/room/${roomId}/messages?${qs}`
  ...
  sendMessage: async (roomId, messageData) => {
    try {
      ...
      const res = await fetch(`${API_URL}/room/${roomId}/message`, {
        method: "POST",
        credentials: "include",
        headers: defaultHeaders,
  ...
  getRoomsByUser: async (userId) => {
    try {
      ...
      const res = await fetch(`${API_URL}/rooms/user/${userId}`, {
        method: "GET",
        credentials: "include",
        headers: defaultHeaders,
      });
  ...
  leaveRoom: async (roomId, userId) => {
    try {
      ...
      const res = await fetch(`${API_URL}/room/${roomId}/leave`, {
        method: "POST",
        credentials: "include",
        headers: defaultHeaders,
        body: JSON.stringify({ userId }),
  ...
  getRoomMembers: async (roomId) => {
    try {
      ...
      const res = await fetch(`${API_URL}/room/${id}/members`, {
        method: "GET",
        credentials: "include",
        headers: defaultHeaders,
      });
