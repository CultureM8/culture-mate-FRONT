...
const togetherApi = {
  ...
  applyTogether: async (togetherId, message) => {
    try {
      ...
      const response = await fetch(`${API_URL}/${togetherId}/apply?message=${encodeURIComponent(message)}`, {
        method: 'POST',
        credentials: 'include',
        headers: getHeaders(),
      });
  ...
  approveParticipation: async (togetherId, participantId) => {
    try {
      ...
      const response = await fetch(`${API_URL}/${togetherId}/participants/${participantId}/approve`, {
        method: 'POST',
        credentials: 'include',
        headers: getHeaders(),
      });
      ...
      console.error(`togetherApi.approveParticipation(${togetherId}, ${participantId}) 에러:`, error);
      throw error;
    }
  },
  ...
  rejectParticipation: async (togetherId, participantId) => {
    try {
      ...
      const response = await fetch(`${API_URL}/${togetherId}/participants/${participantId}/reject`, {
        method: 'POST',
        credentials: 'include',
        headers: getHeaders(),
      });
      ...
      console.error(`togetherApi.rejectParticipation(${togetherId}, ${participantId}) 에러:`, error);
      throw error;
    }
  },
  ...
  getParticipants: async (togetherId, status = null) => {
    try {
      ...
      console.error(`togetherApi.getParticipants(${togetherId}, ${status}) 에러:`, error);
      throw error;
    }
  },
  ...
  cancelParticipation: async (togetherId) => {
    try {
      ...
      const response = await fetch(`${API_URL}/${togetherId}/participants/cancel`, {
        method: 'DELETE',
        credentials: 'include',
        headers: getHeaders(),
      });
      ...
      console.error(`togetherApi.cancelParticipation(${togetherId}) 에러:`, error);
      throw error;
    }
  },
  ...
  removeParticipant: async (togetherId, participantId) => {
    try {
      ...
      const response = await fetch(`${API_URL}/${togetherId}/participants/${participantId}`, {
        method: 'DELETE',
        credentials: 'include',
        headers: getHeaders(),
      });
      ...
      console.error(`togetherApi.removeParticipant(${togetherId}, ${participantId}) 에러:`, error);
      throw error;
    }
  },
  ...
  changeRecruitingStatus: async (togetherId, status) => {
    try {
      ...
      const response = await fetch(`${API_URL}/${togetherId}/recruiting/${status}`, {
        method: 'PATCH',
        credentials: 'include',
        headers: getHeaders(),
      });
      ...
      console.error(`togetherApi.changeRecruitingStatus(${togetherId}, ${status}) 에러:`, error);
      throw error;
    }
  },
