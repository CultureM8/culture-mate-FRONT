...
export default function UsageGuidePage() {
  return (
    <div className="w-full min-h-screen bg-white">
      {/* 이용 가이드 헤더 - 전체 너비 */}
      <section className="
        w-full h-full relative flex flex-col gap-2.5 items-start justify-start 
        px-[clamp(20px,6vw,120px)] py-4
      ">
        <div className="
          w-full relative flex flex-col gap-2.5 items-center justify-center 
          overflow-hidden p-0
        ">
          <div className="
            w-full relative flex flex-row gap-2.5 items-start justify-start 
            p-4
          ">
            <h1 className="
              text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl
              font-semibold text-[#26282a] text-left 
              font-['Inter'] leading-[1.22] tracking-[-0.18px]
              whitespace-nowrap
            ">
              이용 가이드
            </h1>
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="block lg:hidden">
          ...
          <section className="w-full px-4 py-6 border-b border-[#eef0f2]">
            <div className="text-center space-y-4">
              <h3 className="text-xl font-bold text-[#26282a]">
                이벤트 탐색
              </h3>
          ...
          <section className="w-full px-4 py-8">
            <div className="text-center space-y-6">
              <h3 className="text-xl font-bold text-[#26282a] leading-tight">
        ...
        <div className="hidden lg:block">
          {/* 이벤트 탐색 섹션 */}
          <section className="
            w-full relative border-t border-b border-[#eef0f2]
          ...
          ">
            ...
            ">
              ...
              <h3 className="
                ...
                font-bold text-[#26282a] text-center leading-tight w-full
              ">
                이벤트 탐색
              </h3>
          ...
          ">
            ...
            ">
              ...
              <div className="w-full flex flex-col items-center space-y-6 order-1 lg:order-2">
                <h3 className="
                  text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl
                  font-bold text-[#26282a] text-center leading-tight
                ">
                  동행 참여
                </h3>
