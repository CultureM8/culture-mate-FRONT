...
import EventReviewGallery from "../../backup/EventReviewGallery";
                ...
                <div className="absolute top-0 left-0 mt-5 ml-5 flex gap-2">
                  ...
                  <button
                    ...
                    className={`hover:cursor-pointer ${
                      visibilityStates[item.id] === false ? "opacity-30" : ""
                    }`}
                    style={{
                      filter:
                        "brightness(0) saturate(100%) invert(49%) sepia(7%) saturate(241%) hue-rotate(166deg) brightness(93%) contrast(90%)",
                    }}>
                    <Image
                      src={
                        visibilityStates[item.id] === false
                          ? ICONS.INVISIBLE
                          : ICONS.VISIBLE
                      }
                      alt={
                        visibilityStates[item.id] === false ? "비공개" : "공개"
                      }
                      width={22}
                      height={16}
                    />
                  ...
                  <button
                    ...
                    <Image src={ICONS.X} alt="삭제" width={12} height={12} />
                  </button>
                </div>
              )}
            </div>
